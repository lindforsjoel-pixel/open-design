...
export const zhCN: Dict = {
  ...
  'designFiles.git.description': '查看项目更改并创建聚焦的本地提交。',
  'designFiles.git.loading': '正在读取 Git 状态…',
  'designFiles.git.unavailable': '此设备上无法使用 Git。',
  'designFiles.git.notRepository': '此项目尚未纳入版本控制',
  'designFiles.git.initializeDescription': '初始化本地 Git 仓库。不会推送或发布任何内容。',
  'designFiles.git.initialize': '初始化 Git',
  'designFiles.git.detached': '分离的 HEAD',
  'designFiles.git.refresh': '刷新 Git 状态',
  'designFiles.git.clean': '工作树干净',
  'designFiles.git.changes': '{n} 个已更改文件',
  'designFiles.git.selectAll': '全选',
  'designFiles.git.clearSelection': '清除选择',
  'designFiles.git.truncated': '仅显示前 500 个已更改文件。',
  'designFiles.git.commitMessage': '提交消息',
  'designFiles.git.commitPlaceholder': '描述此版本',
  'designFiles.git.commitSelected': '提交所选项 ({n})',
  'designFiles.git.committed': '已创建提交 {hash}。',
