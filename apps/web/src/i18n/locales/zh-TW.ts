...
export const zhTW: Dict = {
  ...
  'designFiles.git.title': '版本控制',
  'designFiles.git.description': '檢視專案變更並建立聚焦的本機提交。',
  'designFiles.git.loading': '正在讀取 Git 狀態…',
  'designFiles.git.unavailable': '此裝置無法使用 Git。',
  'designFiles.git.notRepository': '此專案尚未納入版本控制',
  'designFiles.git.initializeDescription': '初始化本機 Git 儲存庫。不會推送或發佈任何內容。',
  'designFiles.git.initialize': '初始化 Git',
  'designFiles.git.detached': '分離的 HEAD',
  'designFiles.git.refresh': '重新整理 Git 狀態',
  'designFiles.git.clean': '工作樹乾淨',
  'designFiles.git.changes': '{n} 個已變更檔案',
  'designFiles.git.selectAll': '全選',
  'designFiles.git.clearSelection': '清除選取',
  'designFiles.git.truncated': '僅顯示前 500 個已變更檔案。',
  'designFiles.git.commitMessage': '提交訊息',
  'designFiles.git.commitPlaceholder': '描述此版本',
  'designFiles.git.commitSelected': '提交所選項目 ({n})',
  'designFiles.git.committed': '已建立提交 {hash}。',
